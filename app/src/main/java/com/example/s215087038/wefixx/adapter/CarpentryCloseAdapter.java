...
public class CarpentryCloseAdapter extends RecyclerView.Adapter<CarpentryCloseAdapter.MyViewHolder> {
    ...
    public CarpentryCloseAdapter(List<Request> requestList) {
