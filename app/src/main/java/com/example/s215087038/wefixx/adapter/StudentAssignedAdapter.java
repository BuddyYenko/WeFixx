...
public class StudentAssignedAdapter extends  RecyclerView.Adapter<StudentAssignedAdapter.MyViewHolder> {
    ...
    public StudentAssignedAdapter(List<Request> requestList) {
        this.requestList = requestList;
    }

    public StudentAssignedAdapter(Context mCtx, List<Request> requestList) {
        this.mCtx = mCtx;
        this.requestList = requestList;
        this.context = mCtx;
    }
