...
import com.example.s215087038.wefixx.adapter.ElectricalAssignAdapter;
...
public class ElectricalAssignFragment extends Fragment {
    private List<Request> list;
    private RecyclerView recyclerView;
    private ElectricalAssignAdapter aAdapter;
    String url = "http://sict-iis.nmmu.ac.za/wefixx/rsa/by_category.php";
    public ElectricalAssignFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View myFragmentView = inflater.inflate(R.layout.fragment_electrical_assign, container, false);
        list = new ArrayList<>();
        recyclerView = (RecyclerView) myFragmentView.findViewById(R.id.recylcerView);

        aAdapter = new ElectricalAssignAdapter(list);
        ...
        StringRequest stringRequest1 = new StringRequest(com.android.volley.Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    ElectricalAssignAdapter adapter = new ElectricalAssignAdapter(getActivity(), list, ElectricalAssignFragment.this);
