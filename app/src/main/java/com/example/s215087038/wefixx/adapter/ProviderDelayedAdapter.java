...
public class ProviderDelayedAdapter extends RecyclerView.Adapter<ProviderDelayedAdapter.MyViewHolder> {

    private List<Request> requestList;
    private Context mCtx;
    private static int currentPosition = -1;
    AlertDialog.Builder builder;
    public ProviderDelayedAdapter(List<Request> requestList) {
        this.requestList = requestList;
    }

    public ProviderDelayedAdapter(Context mCtx, List<Request> requestList) {
        this.mCtx = mCtx;
        this.requestList = requestList;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_provider_delayed, parent, false);
