...
import com.example.s215087038.wefixx.rsa.ElectricalCloseFragment;
import com.example.s215087038.wefixx.rsa.Manage;

import java.util.List;

public class ElectricalCloseAdapter extends RecyclerView.Adapter<ElectricalCloseAdapter.MyViewHolder> {
    ...
    ElectricalCloseFragment fragment;

    public ElectricalCloseAdapter(List<Request> requestList) {
        this.requestList = requestList;
    }

    public ElectricalCloseAdapter(Context mCtx, List<Request> requestList, ElectricalCloseFragment fragment) {
        this.mCtx = mCtx;
        this.requestList = requestList;
