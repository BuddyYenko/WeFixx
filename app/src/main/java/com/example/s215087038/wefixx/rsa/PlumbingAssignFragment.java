...
import com.example.s215087038.wefixx.adapter.PlumbingAssignAdapter;
...
public class PlumbingAssignFragment extends Fragment {
    private List<Request> list;
    private RecyclerView recyclerView;
    private PlumbingAssignAdapter aAdapter;
    String url = "http://sict-iis.nmmu.ac.za/wefixx/rsa/by_category.php";
    public PlumbingAssignFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View myFragmentView = inflater.inflate(R.layout.fragment_plumbing_assign, container, false);
        list = new ArrayList<>();
        recyclerView = (RecyclerView) myFragmentView.findViewById(R.id.recylcerView);

        aAdapter = new PlumbingAssignAdapter(list);
